...
path = 'C:/Users/patricia/Desktop/vehiclepark/data/data'
...
validation_ds = tf.keras.preprocessing.image_dataset_from_directory(
    ...
    seed=123,
    image_size=(height, width), batch_size=batch_size)
# dataset,validation_split=0.2,subset="validation",seed=123,image_size=(height,width),batch_size=batch_size)
